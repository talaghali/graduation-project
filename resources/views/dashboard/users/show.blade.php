...
<strong class="text-primary">{{ $user->stories_count }}</strong>
</div>
</div>
<hr>
...
<h5 class="mb-0"><i class="bi bi-book me-2"></i>User Stories ({{ $stories->total() }})</h5>
</div>
<div class="card-body">
...
<p class="mb-0">This user hasn't submitted any stories yet</p>
</div>
@endforelse
@if($stories->hasPages())
<div class="mt-4">
